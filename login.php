...
<body>
    ...
    <div class="wrapper">
        <h2 style="color: teal; font-family: sweet_sen; font-size: 42px;">Login Here</h2> <p></p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Login" style="background: teal; border: none;">
            </div>
